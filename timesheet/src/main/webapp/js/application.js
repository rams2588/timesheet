...
function createWorkDay() {
	...
	if (validateInputFields()) {
		...
		var myURL = "http://localhost:8080/tc/timesheet/webapi/services/create";
		$.ajax({
			type : "PUT",
			url : myURL,
...
function getWorkDays() {
	...
	// Perform GET request
	$.getJSON(
					'http://localhost:8080/tc/timesheet/webapi/services',
					function(data) {
...
function deleteWorkDay() {
	...
	var myURL = "http://localhost:8080/tc/timesheet/webapi/services/delete/"
			+ workDayId;
